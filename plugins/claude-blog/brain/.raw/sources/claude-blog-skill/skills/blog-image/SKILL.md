...
Load `../../../../../../skills/blog-image/references/prompt-engineering-blog.md` for domain mode modifier libraries.
...
Load `../../../../../../skills/blog-image/references/mcp-tools.md` for parameter details.
Load `../../../../../../skills/blog-image/references/gemini-models.md` for model specs, pricing, and rate limits.
...
- `../../../../../../skills/blog-image/references/prompt-engineering-blog.md` - Domain modes, 6-component system, blog templates
- `../../../../../../skills/blog-image/references/gemini-models.md` - Model specs, rate limits, aspect ratios, pricing
- `../../../../../../skills/blog-image/references/mcp-tools.md` - MCP tool parameters and response formats
