...
**Runtime context.** Load `../../../../../../skills/blog-flow/references/flow-framework.md` on every `/blog flow`
...
1. Read `../../../../../../skills/blog-flow/references/flow-framework.md`.
...
- `../../../../../../skills/blog-flow/references/flow-framework.md`. FLOW operating model. Load on every `/blog
  flow` activation.
- `../../../../../../skills/blog-flow/references/bibliography.md`. Evidence sources. Load when citing studies or
  statistics.
- `../../README.md`. Prompt index. Load for `/blog flow prompts`.
...
| Scenario | Action |
|----------|--------|
| `../../../../../../skills/blog-flow/references/flow-framework.md` missing | "FLOW reference files not synced. Run: `/blog flow sync`." |
