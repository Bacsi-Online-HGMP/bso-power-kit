...
- `../../../../../../skills/blog-translate/references/translation-rules.md`, format preservation, number/date/currency
  formats per locale, quote handling, quality criteria.
- `../../../../../../skills/blog-translate/references/cultural-adaptation.md`, cultural profiles per locale (DACH,
...
- Pointer to `../../../../../../skills/blog-translate/references/translation-rules.md`.
...
2. Verify structural integrity:
   ...
   - All SVG charts present with translated text labels (length-adjusted:
     DE +30%, FR +15%, JA -20%, others see `../../../../../../skills/blog-translate/references/translation-rules.md`).
   - FAQ count matches.
