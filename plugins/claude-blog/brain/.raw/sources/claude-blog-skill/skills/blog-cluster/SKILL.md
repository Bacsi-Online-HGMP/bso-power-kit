...
- `../../../../../../skills/blog-cluster/references/semantic-clustering.md` (SERP overlap analysis, intent classification, keyword universe expansion)
- `../../../../../../skills/blog-cluster/references/cluster-architecture.md` (hub-and-spoke specs, schema strategy, link-density rules)
- `../../../../../../skills/blog-cluster/references/execution-workflow.md` (execution order, context injection, scorecard, failure handling)
...
Reference: `../../../../../../skills/blog-cluster/references/semantic-clustering.md`
...
Group the expanded keywords using the priority rules in `../../../../../../skills/blog-cluster/references/semantic-clustering.md`:
...
Reference: `../../../../../../skills/blog-cluster/references/cluster-architecture.md`
...
Reference: `../../../../../../skills/blog-cluster/references/execution-workflow.md`
...
This cascade is required because cluster execution is a high-leverage operation (5 to 15 posts at once). Without explicit propagation, individual spokes could silently skip evidence discipline. See `../blog/references/flow-alignment.md`.
...
- Cluster cohesion score: a 0 to 100 composite of link reciprocity, intent diversity, template diversity, and keyword coverage (formula in `../../../../../../skills/blog-cluster/references/execution-workflow.md`).
