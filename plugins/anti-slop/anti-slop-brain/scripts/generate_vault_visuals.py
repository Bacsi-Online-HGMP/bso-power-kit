...
BRAIN_TITLE = "Anti-Slop Brain"
BRAIN_DOMAIN = "detection and repair of AI slop in prose, code, documentation, and agent output, grounded in corpus evidence rather than authorship detection"
BRAIN_TAGLINE = "Source cited Obsidian operating brain for detection and repair of AI slop in prose, code, documentation, and agent output, grounded in corpus evidence rather than authorship detection."
