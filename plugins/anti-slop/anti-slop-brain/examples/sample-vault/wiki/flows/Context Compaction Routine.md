...
A session crosses a task boundary, repeats failed corrections, or needs durable resume state.
...
Use hot, log, and local git history to restart from the last verified state.
