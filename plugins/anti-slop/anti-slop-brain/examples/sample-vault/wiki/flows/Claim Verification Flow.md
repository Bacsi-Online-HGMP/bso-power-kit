...
A note, deliverable, report, or answer contains a claim that could affect a decision.
...
Revert confidence changes and claim-ledger edits in local git if verification was wrong.
